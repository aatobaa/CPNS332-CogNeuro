...
for i = 1:0.1:10
    ...
    pct_correct = decode_PV(testData,goodNeurons,preferredDirections,direction);
    performance = [performance; pct_correct];
end
plot(1:0.1:10,performance)
...
for i = 1:143
    ...
    pct_correct = decode_PV(testData,testNeurons,preferredDirections,direction);
